...
export declare class FirebaseAPI extends FirestoreAPI implements API {
    ...
    constructor(app: App, alerts?: FirebaseAlertsAPI, bubble?: FirebaseBubbleAPI, devices?: FirebaseDevicesAPI, friends?: FirebaseFriendsAPI, invites?: FirebaseInvitesAPI, links?: FirebaseLinksAPI, newAlerts?: FirebaseNewAlertsAPI, profiles?: FirebaseProfilesAPI);
